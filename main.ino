...
const int relay_on_vals[6] {LOW, LOW, LOW, LOW, HIGH, HIGH};
const int relay_off_vals[6] {HIGH, HIGH, HIGH, HIGH, LOW, LOW};
...
const int mixing_pump_index = 1;
const int ph_fix_index = 2;
const int nutrient_peristaltic_index = 3;
const int light_index = 4;
...
void handle_nutrients_helper(float volume_to_dose) {
    ...
    Particle.publish("Nutrients Dosed", volume_to_dose);
}
